...
namespace LanternKeeper.Managers
{
    public class ConfigManager
    {
        ...
        public static void Load()
        {
            ...
            // LANTERN KEEPER
            angerIncrement = LanternKeeper.configFile.Bind(Constants.LANTERN_KEEPER_ENEMY, "Anger Increment", 0.3f, "Anger increment - this value starts at 1 and is used as a multiplier for the enemy's speed and the (direct) damage they inflict");
            angerIncrementLast = LanternKeeper.configFile.Bind(Constants.LANTERN_KEEPER_ENEMY, "Anger Increment Last", 0.6f, "Anger increment when the last lantern is lit");
            ...
            // FORTUNE COOKIE
            auraDuration = LanternKeeper.configFile.Bind(Constants.POISON_DAGGER, "Aura Duration", 20f, "Duration of aura to see the lanterns");
        }
    }
}
